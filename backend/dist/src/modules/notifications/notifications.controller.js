...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lấy danh sách thông báo của người dùng kèm số lượng chưa đọc' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Đánh dấu thông báo là đã đọc' }),
